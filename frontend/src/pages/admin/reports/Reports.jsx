...
import { listAcademicYears } from '../../../services/admin/academicYears'
import { listViolationTypes } from '../../../services/admin/violationTypes'
...
export default function Reports() {
  ...
  useEffect(() => {
    ...
    listViolationTypes({ per_page: 100 })
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
            <div className="min-w-0">
              <p className="text-[11px] font-mono uppercase tracking-widest text-muted-foreground mb-1">
                <span className="text-primary">Admin</span> / <span className="text-brand-green">Reports</span>
              </p>
              <h1 className="text-2xl font-bold text-foreground">Reports</h1>
              <p className="mt-1 text-sm text-muted-foreground">
                Pick a report type, set the filters, then print or save as PDF.
              </p>
            </div>
            <Button
              onClick={handlePrint}
